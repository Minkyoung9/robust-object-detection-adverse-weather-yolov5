...
def run(
    ...
    source=ROOT / "../dataset/DAWN",  # file/dir/URL/glob/screen/0(webcam)
    data=ROOT / "data/data.DAWN",  # dataset.yaml path
    imgsz=(640, 640),  # inference size (height, width)
    conf_thres=0.3,  # confidence threshold
    iou_thres=0.5,  # NMS IOU threshold
    max_det=1000,  # maximum detections per image
    device="2",  # cuda device, i.e. 0 or 0,1,2,3 or cpu
    ...
    project=ROOT / "runs/detect",  # save resu.lts to project/name
...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default=ROOT / "dataset/DAWN", help="file/dir/URL/glob/screen/0(webcam)")
