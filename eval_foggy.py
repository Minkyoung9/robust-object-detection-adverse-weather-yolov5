...
# 경로 설정
results_dir = 'yolov5/runs/test/exp4'  # 결과를 저장할 디렉토리
ground_truth_base_dir = 'dataset/DAWN'  # 실제 주석 파일이 저장된 경로
output_csv = 'evaluation_results.csv'  # 결과를 저장할 CSV 파일

# 제외할 클래스 목록 설정
excluded_classes = [2, 6, 7]

# 클래스 목록 (평가할 클래스 ID 목록)
class_names = {0: 'pedestrian', 1: 'car', 3: 'bus', 4: 'motorcycle', 5: 'bicycle'}
...
def evaluate():
    ...
    for class_id, class_name in class_names.items():
        ...
        ground_truth_dir = os.path.join(ground_truth_base_dir, 'yolo_format_labels')
